package com.sinaon.supportportal.exception;
...
import com.sinaon.supportportal.exception.domain.EmailNotFoundException;
...
public class ExceptionHandling implements ErrorController {
	...
	private static final String ACCOUNT_DISABLED = "Your account has been disabled. If this is an error, please contact adminstration";
	private static final String ERROR_PROCESSING_FILE = "Error occured while processing file";
	private static final String NOT_ENOUGH_PERMISSION = "You do not have enough permissioni";
...
//	To remove default whitelabel page
...
//	}
	...
	public ResponseEntity<HttpResponse> notFound404() {
		return createHttpResponse(NOT_FOUND, "Oh Man! Page not found!");
	}
